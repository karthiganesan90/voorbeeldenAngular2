...
const API_KEY = 'AIzaSyBoeJLUsWjWGz1xYeeahUULqcF9U8I2TmY(REMOVE_THIS)'; // Please, use your own API_KEY in real applications! https://developers.google.com/youtube/v3/getting-started
